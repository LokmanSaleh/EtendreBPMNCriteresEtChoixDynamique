...
import org.eclipse.bpmn2.modeler.examples.customtask.MyModel.util.MyModelResourceFactoryImpl;
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				DocumentRoot documentRoot = MyModelFactory.eINSTANCE.createDocumentRoot();
				TaskConfig root = MyModelFactory.eINSTANCE.createTaskConfig();
				documentRoot.setTaskConfig(root);
