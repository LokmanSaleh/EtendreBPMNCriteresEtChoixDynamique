...
public class MyTaskFeatureContainerSeparateData extends CustomShapeFeatureContainer {

	// these values must match what's in the plugin.xml
	private final static String TYPE_VALUE = "SeparateData";
	private final static String CUSTOM_TASK_ID = "org.eclipse.bpmn2.modeler.examples.customtask.customTask1.separateData";

	public MyTaskFeatureContainerSeparateData() {
	}
