...
public class MyTaskPropertySectionDataPreProcessing extends DefaultPropertySection {

	public MyTaskPropertySectionDataPreProcessing() {
		super();
	}
	...
	protected AbstractDetailComposite createSectionRoot() {
		...
		return new MyTaskDetailCompositeDataPreProcessing(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		// This constructor is used to create the detail composite for use in the popup Property Dialog.
		return new MyTaskDetailCompositeDataPreProcessing(parent, style);
	}
}
